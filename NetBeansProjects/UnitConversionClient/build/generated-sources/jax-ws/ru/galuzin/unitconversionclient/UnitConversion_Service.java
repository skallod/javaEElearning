 ...
 * 
 */
@WebServiceClient(name = "UnitConversion", targetNamespace = "http://webservices.galuzin.ru/", wsdlLocation = "http://localhost:8080/UnitConversion/UnitConversion?wsdl")
    ...
    extends Service
{
    ...
    private final static QName UNITCONVERSION_QNAME = new QName("http://webservices.galuzin.ru/", "UnitConversion");
    ...
    public UnitConversion getUnitConversionPort() {
        return super.getPort(new QName("http://webservices.galuzin.ru/", "UnitConversionPort"), UnitConversion.class);
    }
    ...
    public UnitConversion getUnitConversionPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.galuzin.ru/", "UnitConversionPort"), UnitConversion.class, features);
    }
